              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a href="https://x.com/bookshelfieapp" target="_blank" rel="noopener noreferrer" className="text-sm text-brand-600 hover:text-brand-700 hover:underline">
                      @bookshelfieapp
                    </a>
                    <span className="text-gray-300">|</span>
                    <a href="https://linkedin.com/company/bookshelfie" target="_blank" rel="noopener noreferrer" className="text-sm text-brand-600 hover:text-brand-700 hover:underline">
                      LinkedIn
                    </a>
                  </div>
                </div>
